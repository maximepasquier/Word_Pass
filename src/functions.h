...
std::map<std::string, std::string> Saisie_mdp();
void afficher_dictionnaire(std::map<std::string, std::string> mdp);
std::string get_dictionary_mdp(std::map<std::string, std::string> mdp, std::string nouveau_mot_de_passe);